  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        name: formData.name,
        organization_name: registrationType === 'organization' ? formData.organization_name : null,
        organization_type: registrationType === 'organization' ? formData.organization_type : null,
        contact_number: formData.phone,
        email: formData.email || 'not-provided@example.com',
        message: formData.message || null
      };

      const response = await fetch(`${API_URL}/api/cyber-warriors/register`, {
        method: 'POST',
      ...
      if (response.ok) {
        ...
        redirectToThankYou('cyber', { name: formData.name });
        return;
      } else {
