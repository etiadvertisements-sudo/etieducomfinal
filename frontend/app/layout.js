...
const jsonLd = {
  ...
  // aggregateRating moved to /api/reviews/stats — included only on pages where
  // we have real, moderated review counts (currently below Google's reliability
  // threshold of 5+ reviews, so omitted to avoid spam-flag).
  sameAs: [
